...
![OncRAG pipeline architecture](results/architecture_diagram.png)
![Distribution of the 200 evaluation questions across 6 categories](results/category_distribution.png)
![Question volume and mean faithfulness across all 14 tags](results/category_faithfulness_volume.png)
